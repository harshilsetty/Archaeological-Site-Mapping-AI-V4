...
- Encoder: ResNet34
- Classes: 6
- Active weights used for inference: `models/deeplab_model.pth`
...
- Main artifact used by inference: `models/erosion_model.pkl`
...
- Path: `seg_dataset`
- Masks generated from COCO via `scripts/data_prep/generate_masks.py`
- Classes:
  - 0 background
  - 1 boulders
  - 2 others
...
From `scripts/training/train_deeplab_seg.py` (updated):
...
- `scripts/training/train_deeplab_seg.py` now supports saving:
  - `deeplab_metrics.csv`
...
![Hampi app output](../screenshots/app-hampi.png)
![Khajuraho app output](../screenshots/app-khajuraho.png)
![Nalanda app output](../screenshots/app-nalanda.png)
...
1. Script naming: `scripts/training/train_seg.py` trains detection, not segmentation.
